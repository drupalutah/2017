...
/**
 * @file
 * Display Suite Fluid Two Column 66 33 template.
 *
 * Available variables:
 *
 * Layout:
 ...
 */
  ...
  if (($left && !$right) || ($right && !$left)) $classes .= ' ds-cta-one-column';
  if ($left && $right) $classes .= ' ds-cta-two-columns';
  if ($left) $classes .= ' ds-cta-column-left';
  if ($right) $classes .= ' ds-cta-column-right';
?>
